...
//Application Title
define('APP_TITLE', 'wz.wuzhij.com');
...
$auth_users = array(
    'sunyi' => '$2y$10$tI4ijyMqQFcWVW9IC0FaxOSunf2Nw5iTtRfMH5NLncARxtDGEjW5i', //admin@123
    'user' => '$2y$10$tI4ijyMqQFcWVW9IC0FaxOSunf2Nw5iTtRfMH5NLncARxtDGEjW5i' //12345
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="wuzhij" aria-label="wuzhij">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://wuzhij.com/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">by wuzhij</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://s.wuzhij.com" target="_blank" class="app-v-title"> s.wuzhij.com <?php echo VERSION; ?></a></h3></p>
...
<head>
    ...
    <meta name="description" content="wuzhij.com">
